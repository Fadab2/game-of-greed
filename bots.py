...
class TestBot(BaseBot):
    def _roll_bank_or_quit(self):
        """your logic here"""
        if self.unbanked_points >= 50 or self.dice_remaining < 2:
            return "b"
        elif self.unbanked_points >= 350 or self.dice_remaining < 4:
            return "b"
        elif self.unbanked_points >= 450 or self.dice_remaining < 5:
            return "b"
